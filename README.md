...
2. **Database Configuration**
   ...
   *(This automatically creates all tables and the required `is_approved` structure).*
...
* *Note: The very first admin must be approved manually in phpMyAdmin by setting `is_approved` to 1 in the `admin` table.*
